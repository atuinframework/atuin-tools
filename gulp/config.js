...
config = {
	'src' : {
		...
		'atuincms_css' 		: [ paths.static_atuincms.src.css.root + '/style.scss' ],
		'atuincms_css_admin': [ paths.static_atuincms.src.css.root + '/admin/style.scss' ],
	...
	'min' : {
		...
		'atuincms_img'  : paths.static.min.img.atuincms.root
	},
	'lib' : paths.lib.root
};
